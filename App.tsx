      ...
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-5xl relative z-10">
        ...
        <header className="text-center mb-16 md:mb-24 animate-in fade-in slide-in-from-bottom-4 duration-1000">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-6 md:gap-10 font-mono-code text-sm md:text-base tracking-[0.2em]" style={{ 
            ...
            >
              <span className="w-3 h-3 rounded-full bg-green-500 animate-pulse"/> <span className="font-bold">STATUS: ONLINE</span>
            </span>
            <span 
              ref={roleRef}
              className={`flex items-center gap-3 transition-all duration-500 ${
            ...
            >
                ...
                <span className="font-bold">ROLE: "DEVOPS ENGINEER"</span>
              </span>
            <span className="flex items-center gap-3">
                ...
                <span className="font-bold">LOCATION: KATHMANDU, NEPAL</span>
              </span>
          </div>
          ...
          >
             {SOCIAL_LINKS.map((social, index) => {
               // Set colors: LinkedIn stays blue, GitHub uses theme text, others use theme accent
               ...
               return (
                 <a
                   ...
                   onMouseEnter={(e) => {
                     e.currentTarget.style.borderColor = isGitHub ? 'var(--theme-text)' : accentColor;
                     e.currentTarget.style.color = isGitHub ? 'var(--theme-text)' : accentColor;
                     e.currentTarget.style.backgroundColor = 'var(--theme-surface)';
                     e.currentTarget.style.transform = 'translateY(-2px) scale(1.05)';
                 ...
                 >
                   <span 
                     ...
                     style={{ 
                       color: isGitHub ? 'var(--theme-text)' : accentColor
                     }}
        ...
        <div className="relative mb-24">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-sm md:text-base max-w-2xl mx-auto" style={{ 
              ...
              <strong>My expertise in modern DevOps technologies and practices</strong>
            </p>
          </div>
